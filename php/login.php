...
<section class="container register-form py-3 text-center">

        <?php
        session_start();
        $message="";
        if(count($_POST)>0) {
            $con = mysqli_connect('127.0.0.1:3306','root','','amozeshyar') or die('Unable To connect');
    ...
    <form name="frmUser" method="post" action="">
        ...
        <br>
        <button type="submit" name="submit" value="Submit" class="btn btn-secondary w-25">ورود</button>
    </form>
